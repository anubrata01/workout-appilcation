...
MIDDLEWARE = [
    ...
    "notifications.logging_utils.RequestLoggingMiddleware",
]
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_THROTTLE_RATES": {
        "notifications-write": "60/min",
        "notifications-read": "120/min",
    },
}
...
LOGGING = {
    ...
    "formatters": {"json": {"()": "notifications.logging_utils.JsonFormatter"}},
